      ...
      <div class="limit prog-page">
        <div class="row-content">
          <div class="list-prog">
            ...
            <button class="gold-btn" onclick="document.location.href='/cabinet/page1'"><?php echo $this->lang->line('bonus_p_2');?></button>
                  ...
                  <form>
                    ...
                    <script type="text/javascript">
                      $('#sel_filter').on('change', function(){
                        document.location.href = '/cabinet/page1/'+$('#sel_filter').val();
                      })
                    </script>
                  </form>
                </div>
        ...
        <div class="row-content no-auto">
          <div class="left-col">
            <h3><?php echo $this->lang->line('bonus_ph_2');?></h3>
            <?php
              if(count($user_scales) > 0) {
                ...
                <?php
                  ...
                  ?>
                      ...
                      <div style="text-align: center; font-weight: bold;">
                        <p><?php echo $this->lang->line('page1_mess_1');?></p>
                        <p><?php echo $this->lang->line('page1_mess_2');?></p>
                        <p><?php echo $this->lang->line('page1_mess_3');?></p>

                        <p style="color:red;"><?php echo $this->lang->line('page1_mess_4');?></p>
                        <p style="color:red;"><?php echo $this->lang->line('page1_mess_5');?></p>

                        <p style="color:blue;"><?php echo $this->lang->line('page1_mess_6');?></p>
                        <p style="color:blue;"><?php echo $this->lang->line('page1_mess_7');?></p>

                        <p><?php echo $this->lang->line('page1_mess_8');?></p>
                        <p><?php echo $this->lang->line('page1_mess_9');?></p>
                        <p><?php echo $this->lang->line('page1_mess_10');?></p>
                        <p><?php echo $this->lang->line('page1_mess_11');?></p>
                        <p><?php echo $this->lang->line('page1_mess_12');?></p>
                      </div>
                  <?php  
                    }else {
                    if(isset($_GET['false'])) {
                  ...
                  ?>
                  <div class="list-prog">
                    <button class="gold-btn" onclick="document.location.href='/cabinet/buyplace/2'"><?php echo $this->lang->line('bonus_buy');?>(<?php echo $info = json_decode($mark_setts['packet_2']); echo $info->all_sum;?> Credit)</button>
                  </div>
                  <div style="text-align: center; font-weight: bold;">
                        <p><?php echo $this->lang->line('page1_mess_1');?></p>
                        <p><?php echo $this->lang->line('page1_mess_2');?></p>
