	...
	<div class="row">
		 ...
		 <div class="x_title">
				   ...
				   <form data-parsley-validate class="form-horizontal form-label-left" method="post">
                        ...
                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="title_russian"><?php echo $this->lang->line('news_title');?> на русском
                        </label>
					...
					<div class="form-group">
                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="text_body"><?php echo $this->lang->line('news_text');?> на русском
                        </label>
                        <div class="col-md-11 col-sm-6 col-xs-12">
					  ...
					  <hr />
					  <div class="form-group">
                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="title_english"><?php echo $this->lang->line('news_title');?> на английском
                        </label>
                        <div class="col-md-11 col-sm-6 col-xs-12">
					...
					<div class="form-group">
                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="text_body"><?php echo $this->lang->line('news_text');?> на английском
                        </label>
                        <div class="col-md-11 col-sm-6 col-xs-12">
					  ...
					  <hr />
					  <div class="form-group">
                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="title"><?php echo $this->lang->line('news_title');?> на немецком
                        </label>
                        <div class="col-md-11 col-sm-6 col-xs-12">
					...
					<div class="form-group">
                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="text_body"><?php echo $this->lang->line('news_text');?> на немецком
                        </label>
                        <div class="col-md-11 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="title"><?php echo $this->lang->line('news_title');?> на венгерском
                        </label>
                        <div class="col-md-11 col-sm-6 col-xs-12">
					...
					<div class="form-group">
                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="text_body"><?php echo $this->lang->line('news_text');?> на венгерском
                        </label>
                        <div class="col-md-11 col-sm-6 col-xs-12">
