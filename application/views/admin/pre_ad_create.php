				   	...
				   	<form enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" method="post">
				   			...
				   			<div id="for_left">
				   				...
				   				<div id="text" style="display:none;">
									<div class="form-group">
				                        ...
				                        <div class="col-md-11 col-sm-6 col-xs-12">
				                          <textarea name="text_left" rows="15" class="form-control col-md-12 col-xs-12"></textarea>
										</div>
				                    </div>
				                </div>
				                <div id="video" style="display:none;">
					                <div class="form-group">
										...
										<div class="col-md-11 col-sm-6 col-xs-12">
											<input type="text" name="vid_left" class="form-control col-md-12 col-xs-12">
										</div>
									</div>
								</div>
				        ...
				        <div>
				   			...
				   			<div id="for_mid">
				   				...
				   				<div id="text_mid" style="display:none;">
									<div class="form-group">
				                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="title_russian">Text to add</label>
				                        <div class="col-md-11 col-sm-6 col-xs-12">
				                          <textarea name="text_mid" rows="15" class="form-control col-md-12 col-xs-12"></textarea>
										</div>
				                    </div>
				                </div>
				                <div id="video_mid" style="display:none;">
					                <div class="form-group">
										<label class="control-label col-md-1 col-sm-3 col-xs-12" for="title_english">Video</label>
										<div class="col-md-11 col-sm-6 col-xs-12">
											<input type="text" name="vid_mid" class="form-control col-md-12 col-xs-12">
										</div>
									</div>
								</div>
								<div id="img_mid" style="display:none;">
									Image type<br>
				        ...
				        <div>
				   			...
				   			<div id="for_right">
				   				...
				   				<div id="text_right" style="display:none;">
									<div class="form-group">
				                        <label class="control-label col-md-1 col-sm-3 col-xs-12" for="title_russian">Text to add</label>
				                        <div class="col-md-11 col-sm-6 col-xs-12">
				                          <textarea name="text_right" rows="15" class="form-control col-md-12 col-xs-12"></textarea>
										</div>
				                    </div>
				                </div>
				                <div id="video_right" style="display:none;">
					                <div class="form-group">
										<label class="control-label col-md-1 col-sm-3 col-xs-12" for="title_english">Video</label>
										<div class="col-md-11 col-sm-6 col-xs-12">
											<input type="text" name="vid_right" class="form-control col-md-12 col-xs-12">
										</div>
									</div>
								</div>
								<div id="img_right" style="display:none;">
									Image type<br>
